...
<html>
	<head>
		...
		<!-- favicon meta -->
		<link rel="icon" href="samsung.ico" type="image/x-icon"/>
		<link rel="shortcut icon" href="samsung.ico" type="image/x-icon"/>
		<!-- end favicon meta -->
		<!-- end meta elements -->
...
<body>
	...
	# Movies
	else if ($menu == 8) { include("Movies.php"); }
	
	print '
	</main>
	<footer>
		<p>Copyright &copy; ' . date("Y") . ' Mario Kalisar</p>
	</footer>
</body>
</html>';
?>
